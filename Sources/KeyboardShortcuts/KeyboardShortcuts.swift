    ...
    public enum KeyboardShortcuts {
        ...
        private static var allShortcutsKeyUpHandlers = [(KeyboardShortcuts.Name) -> Void]()
        ...
        public static func onKeyUp(_ action: @escaping (Name) -> Void) {
            allShortcutsKeyUpHandlers.append(action)
        }
